...
st.markdown(
    ...
    .stApp {
        background-color: #e8b7f7;  /* Optional: You can set a background color or use a background image as well */
    }
    .centered-box {
...
# Title with rainbow emojis
st.markdown('<h1 class="serif-font">🌈 Personal Recommendation System 🌈</h1>', unsafe_allow_html=True)

# Description text
st.markdown('<p class="serif-font">Get a personal color analysis to find out what products best suit you!</p>', unsafe_allow_html=True)
